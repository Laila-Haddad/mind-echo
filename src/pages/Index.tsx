...
import EEGConnectButton from "@/components/EEGConnectButton";
...
const IndexContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      ...
      {/* Main content */}
      <main className="md:px-4 py-8 min-h-screen space-y-12 grid items-center justify-center">
        <section
          aria-label="Connect to device"
          className="text-center space-y-8 mt-8"
        >
          <EEGConnectButton setDisplay={setDisplayContent} />
        </section>
        {displayContent && (
          <>
            <section
      ...
      {displayContent && (
        <div
          ...
          className="-mx-8 bg-muted mt-10 h-fit p-24 pt-8"
        >
      ...
      <footer className="border-t border-border -m-8 bg-secondary">
        <div className="container mx-auto px-10 py-6 text-center flex justify-between items-center">
          <div
            dir="ltr"
            className="flex items-center w-fit justify-center space-x-3"
          >
